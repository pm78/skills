---
name: strategy-intelligence-ops
description: Strategic intelligence operations for market scanning and long-form synthesis.
---

# strategy-intelligence-ops

## Purpose
- Execute role-specific operations for the strategist agent.

## Context Inputs
- Company memory file: ~/.ai-memory/company_knowledge.md
- Role memory file: ~/.ai-memory/roles/strategist_memory.md
