---
name: sales-execution-ops
description: Sales execution for CRM sync, proposals, invoices, and RFP extraction.
---

# sales-execution-ops

## Purpose
- Execute role-specific operations for the sales agent.

## Context Inputs
- Company memory file: ~/.ai-memory/company_knowledge.md
- Role memory file: ~/.ai-memory/roles/sales_memory.md
