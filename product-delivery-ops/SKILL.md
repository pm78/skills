---
name: product-delivery-ops
description: Product planning and execution operations across backlog, slides, and competitor tracking.
---

# product-delivery-ops

## Purpose
- Execute role-specific operations for the product agent.

## Context Inputs
- Company memory file: ~/.ai-memory/company_knowledge.md
- Role memory file: ~/.ai-memory/roles/product_memory.md
