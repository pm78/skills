...
description: Marketing execution for social publishing, image generation, and keyword extraction.
---

# marketing-content-ops

## Purpose
- Execute role-specific operations for the marketer agent.

## Context Inputs
- Company memory file: ~/.ai-memory/company_knowledge.md
- Role memory file: ~/.ai-memory/roles/marketer_memory.md
