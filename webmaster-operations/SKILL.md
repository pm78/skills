---
name: webmaster-operations
description: Webmaster deployment, CMS automation, and technical SEO operations.
---

# webmaster-operations

## Purpose
- Execute role-specific operations for the webmaster agent.

## Context Inputs
- Company memory file: ~/.ai-memory/company_knowledge.md
- Role memory file: ~/.ai-memory/roles/webmaster_memory.md
